...
sudo cp -r include psp.cpp conf.cpp libsqlite.a tinyxml.a /usr/local/psp
cd /usr/local/psp
...
cd ..
cd ..
sudo g++ psp.cpp conf.cpp libsqlite.a tinyxml.a -o psp -ltins -std=c++11 -ldl -lpthread -I include
